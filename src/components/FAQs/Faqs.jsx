...
const Faqs = () => {
  ...
  return (
    <section className="bg-[#efeee5] pb-20 text-[#274546] relative space-y-16">
      ...
      >
        <article className="accordion-panel space-y-4 cursor-pointer">
          ...
          <div
            ...
            id="panel1-content"
          >
            <div className="font-jost font-normal text-sm lg:text-base text-[#274546]/80 lg:w-5/6 space-y-6">
              <p>
                ...
                <em className="font-bold">$500 - $1,000</em>
              </p>
              <p>
              ...
              <p>
                ...
                will cost you around <em className="font-bold">$100 - $200</em>
              </p>
            </div>
          </div>
          <div className="h-[0.5px] md:h-[0.1px] bg-[#274546]/20 flex-grow w-full lgw-3/6"></div>
        </article>
          ...
          >
            <div className="font-jost font-normal text-sm lg:text-base text-[#274546]/80 lg:w-5/6 space-y-6">
              <p className="text-[#274546]/80">
                ...
                take approximately <em className="font-bold">3 - 10 weeks</em>,
        ...
        <article className="accordion-panel space-y-4 cursor-pointer">
          ...
          >
            <div className="font-jost font-normal text-sm lg:text-base text-[#274546]/80 lg:w-5/6 space-y-6">
              <p className="text-[#274546]/80">
                <em className="font-bold">Yes</em>, I can help with e-commerce
                shops that have basic needs or are large and complex websites
